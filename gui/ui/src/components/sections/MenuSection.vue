                    ...
                    <div class="sided-90x mb-30">
                        ...
                        <div class="s-right">
                            <h5 class="mb-10">
                                ...
                                ><b class="color-primary float-right">$12.00</b>
                            </h5>
                            <p class="pr-70">
                ...
                <div class="col-md-6">
                    <div class="sided-90x mb-30">
                        ...
                        <div class="s-right">
                            <h5 class="mb-10">
                                <b>Italian pasta</b
                                ><b class="color-primary float-right">$20.00</b>
                            </h5>
                            <p class="pr-70">
                                Proin dictum viverra varius. Etiam vulputate
                                libero dui, at pretium elit elementum quis.
                            </p>
                        </div>
                        <!--s-right-->
                    </div>
                ...
                <div class="col-md-6">
                    <div class="sided-90x mb-30">
                        ...
                        <div class="s-right">
                            <h5 class="mb-10">
                                <b>Broschettas</b
                                ><b class="color-primary float-right">$6.00</b>
                            </h5>
                            <p class="pr-70">
                                Proin dictum viverra varius. Etiam vulputate
                                libero dui, at pretium elit elementum quis.
